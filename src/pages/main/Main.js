    ...
    <div>
      <div className="absolute left-10 top-10">
        <img
          ...
          alt="money"
          className="scale-[10%] absolute left-[30px] top-[-115px] animate-pulse"
        />
        <h1 className=" font-medium text-sub text-[17px]">잘 살아보기</h1>
        <h1 className="font-bold text-main text-[30px] ml-3">나의 텅장</h1>
      </div>
